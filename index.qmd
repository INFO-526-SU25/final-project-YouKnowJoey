...
breaks = c("Cat", "Dog", "Other", pal_brewer(palette = "Dark2"))
...
longbeach_clean |>
  ...
  ggplot(aes(x = n, y = reorder(animal_type, n), fill = species_group)) +
    ...
    theme(
      ...
      caption.text =  element_text(size = 20),
...
# 95th percentile of days_to_adoption
p95 <- quantile(adopt_df_full$days_to_adoption, 0.95, na.rm = TRUE)

# counts per year & species for bar fills
