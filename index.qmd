...
longbeach_clean |>
  count(animal_type, species_group, sort = TRUE) |>
    ...
    scale_x_continuous(
      expand = expansion(mult = c(0, 0.077)),
    ...
    theme(
      ...
      plot.title = element_text(face = "bold", hjust = 0.068, size = 15),
      plot.subtitle = element_text(hjust = 0.05, size = 12),
...
ggplot(top_6_intake, 
  ...
  theme_minimal()+
    theme(
      plot.title.position = "plot",
      plot.title = element_text(face = "bold", hjust = 0.068, size = 15),
      plot.subtitle = element_text(hjust = 0.028, size = 12),
      axis.text = element_text(size = 10),
      axis.title = element_text(size = 12),
      plot.caption = element_text(margin = margin(t = 10), size = 12),
      panel.grid.major = element_line(color = "grey95", linewidth = 0.1),
